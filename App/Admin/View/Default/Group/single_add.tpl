...
<head>
  <meta charset="utf-8"/>
  <title>添加用例 | 用例组管理 | 自动化测试系统</title>
            ...
            <nav class="navbar" role="navigation">
              ...
              <div class="portlet mt-element-ribbon light portlet-fit bordered">
                ...
                <div class="portlet-body list">
                  ...
                  <p class="margin-bottom-10 tooltips" data-original-title="创建时间"><i class="fa fa-calendar font-blue"></i>{$group.create_time|strtotime|date="Y-m-d",###}</p>
            ...
            <div class="row">
              <div class="col-md-12">
                <form class="form-horizontal form-row-seperated" action="./addSingle" method="post" id="atsform">
                  <input type="hidden" name="tid" value="{$group.id}"/>
                    ...
                    <div class="portlet-title">
                      ...
                      <div class="breadcrumbs">
                        ...
                        <ol class="breadcrumb">
                          ...
                          <li>
                            <a href="/Group/single/tid/{$group.id}">用例管理</a>
                          </li>
                      ...
                      <div class="actions btn-set">
                        <a href="/Group/single/id/{$group.id}" class="btn dark btn-secondary-outline">
                                ...
                                <div class="col-md-12">
                                  <div class="form-group form-md-line-input">
                                    <input type="text" class="form-control" name="v1[]"
                                           placeholder="如: intent.slots.whois">
...
<script src="/Public/assets/apps/scripts/group/single_add.js"></script>
