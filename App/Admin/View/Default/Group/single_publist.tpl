                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                  <div class="portlet-title">
                    <div class="caption">
                      ...
                      <span class="caption-subject font-dark sbold uppercase">用例列表</span>
                    </div>
                    <!-- BEGIN BREADCRUMBS -->
                  ...
                  <div class="portlet-body">
                    <div class="table-container">
                      <div class="m-heading-1 border-green m-bordered">
                        <div class="row">
                          <div class="col-md-4"><p class="margin-bottom-10 tooltips"><i
                                class="fa fa-object-group font-blue"></i>名称:</p> {$group.name}</div>

                          <div class="col-md-2"><p class="margin-bottom-10 tooltips"><i class="fa fa-gg font-blue"></i>属性:
                            </p>
                          ...
                          <div class="col-md-2"><p class="margin-bottom-10 tooltips"><i
                                class="fa fa-user font-blue"></i>所属用户:</p> {$group.nickname}
                            <if
                              condition="($group.nickname eq null) OR ($group.nickname eq '') ">{$group.nickname} </if>
                          </div>
                          <div class="col-md-3"><p class="margin-bottom-10 tooltips"><i
                                class="fa fa-calendar font-blue"></i>创建时间:
                            </p> {$group.create_time|strtotime|date="Y-m-d",###}</div>
                        </div>
                      </div>
...
<script src="/Public/assets/apps/scripts/group/single_publist.js"></script>
