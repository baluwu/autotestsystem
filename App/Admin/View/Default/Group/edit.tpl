...
<head>
  <meta charset="utf-8"/>
  <title>编辑用例组 | 用例组管理 | 自动化测试系统</title>
                  ...
                  <div class="portlet  light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                      ...
                      <div class="actions btn-set">
                        <a href="/Group/index" class="btn dark btn-secondary-outline">
                          ...
                          <div class="tab-pane active" id="tab_general">
                            <div class="form-body">
                              <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-10">
                                  <input type="text" name="name" class="form-control" maxlength="20" id="name" value="{$data.name}" placeholder="名称">
                              ...
                              <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-4">
                                  ...
                                  <option value="{$iv.id}" <?php if ($data['classify'] == $iv['id']) { ?>selected <?php } ?> >{$iv.name}
                                  </option>
                                  </foreach>
                                  </select>
                                  <div class="form-control-focus"></div>
                              ...
                              <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-10">
                                  ...
                                  <div class="md-radio-inline">
                                    <div class="md-radio">
                                      <input type="radio" id="property1" name="property" value="1" class="md-radiobtn" <if condition="($data.ispublic eq 1)"> checked</if>>
                                      <label for="property1">
                                        <span></span>
                                    ...
                                    <div class="md-radio">
                                      ...
                                      <if condition="($data.ispublic eq 0)"> checked</if>>
                                      <label for="property2">
                                        <span></span>
                                        <span class="check"></span>
...
<script src="/Public/assets/apps/scripts/group/edit.js"></script>
