                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                  <div class="portlet-title">
                    ...
                    <div class="breadcrumbs">
                      ...
                      <ol class="breadcrumb">
                        ...
                        <li>
                          <a href="/Group/pub">公共用例组</a>
                        </li>
                        <li>
                          <a href="/Group/execute_history_pub/tid/{$group.id}">执行记录</a>
                        </li>
                        <li class="active">执行记录详情</li>
                      </ol>
                  ...
                  <div class="portlet-body">
                    <div class="m-heading-1 border-green m-bordered">
                      <div class="row">
                        <div class="col-md-4">  <p class="margin-bottom-10 tooltips"><i class="fa fa-object-group font-blue"></i>名称:</p> {$group.name}</div>

                        <div class="col-md-2">  <p class="margin-bottom-10 tooltips"><i class="fa fa-gg font-blue"></i>属性:</p><if condition="($group.ispublic eq 1)">公有<else />私有</if></div>

                        <div class="col-md-2">  <p class="margin-bottom-10 tooltips"><i class="fa fa-user font-blue"></i>所属用户:</p> {$group.nickname}<if condition="($group.nickname eq null) OR ($group.nickname eq '') ">{$group.nickname} </if></div>
                        <div class="col-md-3">  <p class="margin-bottom-10 tooltips"><i class="fa fa-calendar font-blue"></i>创建时间:</p> {$group.create_time|strtotime|date="Y-m-d",###}</div>
                          <div><p class="margin-bottom-10" ><i class="fa fa-rotate-left font-blue"></i>
                                ...
                                <td colspan="2">
                                  <table class="table table-bordered table-striped table-condensed flip-content">
                                    <tr>
                                      ...
                                      <tr>
                                          <td>用例规则</td>
                                          <td><volist name=":unserialize($d['validates'])" id="v">
                                                  <li >{$v.v1}{$v.dept}{$v.v2}</li>
                                              </volist></td>
                                      </tr>
                                    <tr>
                                      <td>执行成败</td>
                                      <td> <if condition="($d.issuccess eq 1) ">成功<else />失败 </if></td>
                                    </tr>
                                    <tr>
                                      <td>开始执行时间</td>
