...
<head>
  <meta charset="utf-8"/>
  <title>用例执行记录 | 公共用例组 | 自动化测试系统 </title>
                  ...
                  <div class="portlet-body">
                    <div class="m-heading-1 border-green m-bordered">
                      <div class="row">
                        ...
                        <div class="col-md-2"><p class="margin-bottom-10 tooltips"><i class="fa fa-user font-blue"></i>所属用户:
                          </p> {$group.nickname}
...
<script src="/Public/assets/apps/scripts/group/excute_history_pub.js"></script>
