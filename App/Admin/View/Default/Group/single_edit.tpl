...
<head>
  <meta charset="utf-8"/>
  <title>编辑用例 | 用例组管理 | 自动化测试系统</title>
                  ...
                  <div class="portlet  light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                      ...
                      <div class="actions btn-set">
                        <a href="/Group/single/tid/{$group.id}" class="btn dark btn-secondary-outline">
...
<script src="/Public/assets/apps/scripts/group/single_edit.js"></script>
