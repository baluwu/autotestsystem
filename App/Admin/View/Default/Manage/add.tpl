...
<head>
  ...
  <link href="/Public/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.css" rel="stylesheet"
        type="text/css"/>
  ...
  <link href="/Public/assets/global/plugins/bootstrap-select/css/bootstrap-select.min.css" rel="stylesheet"
        type="text/css"/>
                          ...
                          <div class="col-md-4">
                            <div class="input-group has-success" id="emailwarp">
                              <input type="text" class="form-control" id="email" name="email" autocomplete="off"
                                     placeholder="Email Address"><span class="input-group-addon"><i
                          ...
                          <div class="col-md-4">
                            <select class="form-control" name="groupid">
                              <volist name="auth_group" id="auth">
                                <option value="{$auth.id}" {$auth.id==3?'selected':''} >{$auth.title}</option>
                              </volist>
                            </select>
