...
<head>
  <meta charset="utf-8"/>
  <title><?php _e('Public Case');> | <?php _e('Auto Test System'); ?></title>
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                  <div class="portlet-title">
                    <div class="caption">
                      ...
                      <span class="caption-subject font-dark sbold uppercase"><?php _e('Public Case'); ?></span>
                    </div>
                    <!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                      <ol class="breadcrumb">
                        ...
                        <li class="active"><?php _e('Public Case'); ?></li>
                      </ol>
                    </div>
                    <!-- END BREADCRUMBS -->
                  </div>
...
<script src="/Public/assets/apps/scripts/single/public.js?ssss"></script>
