          ...
          <div class="page-sidebar">
            <nav class="navbar" role="navigation">
              ...
              <ul class="nav navbar-nav">
                <li class="active"> <a href="./add"><i class="fa fa-plus "></i> 添加用例</a> </li>
              </ul>
              <h3>Quick Actions</h3>
              <ul class="nav navbar-nav margin-bottom-35">
                <li> <a href="/Group/index"><i class="fa fa-object-ungroup"></i> 用例组管理 </a> </li>
              </ul>
            </nav>
          </div>
                ...
                <form class="form-horizontal form-row-seperated" action="./addSingle" method="post" id="atsform">
                  <div class="portlet  light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                      <div class="caption"> {$project_name} / {$model_name} / {$group_name} </div> 
