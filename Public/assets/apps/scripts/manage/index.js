                ...
                success: function (data, response, status) {
                  if (data == 0) {
                    App.notification({
                      type: 'danger',
                      icon: 'warning',
                      message: (act=="Remove"?_et('Disable'):_et('Activate'))+_et('Fail'),
                  ...
                  App.notification({
                    type: 'success',
                    icon: 'success',
                    message: (act=="Remove"?_et('Disable'):_et('Activate'))+_et('Succeed'),
                    container: $(".page-content-col .portlet-title"),
                    place: 'prepend'
                  });
