    ...
    return {
        ...
        notification: function (options) {
          var _opts={
            ...
            closeInSeconds:1 // Time while the message will be displayed. It's not equivalent to the *demo* timeOut!
          };
          ...
          $.bootstrapGrowl(opts.message, {
            ...
            offset: {
              ...
              amount: opts.offset.amount
            },
            align:opts.align,
            width: parseInt(opts.width),
            delay: opts.closeInSeconds*1000,
