    ...
    var handleRecords = function () {
      ...
      grid.init({
        ...
        dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
          ...
          "ajax": {
            "url": CONFIG['MODULE'] + '/Group/getHistory/id/'+CONFIG['ID'] // ajax source
          },
          keys: true,
          columns: [
            {
          ...
          "columnDefs": [
            ...
            },
            {
              "render": function (data, type, row) {
                ...
                return  '<a target="_blank" href="/Group/execute_history_show/tid/'+CONFIG['ID']+'/id/'+data.id+'" class="btn green-jungle btn-sm btn-outline margin-bottom-5"> <i class="fa fa-info-circle"></i> 查看 </a>';
