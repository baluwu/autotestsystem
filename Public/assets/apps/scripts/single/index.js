    ...
    var handleRecords = function () {
      ...
      grid.init({
        ...
        onDataLoad: function (grid) {
          ...
          $('[data-toggle="confirmation"]').each(function () {
            ...
            $(this).on('confirmed.bs.confirmation', function () {
              $.ajax({
                url: CONFIG['MODULE'] + '/Single/Remove',
                type: 'POST',
                data: {
                  ids: $(this).data('id')
                },
        ...
        dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
          ...
          "ajax": {
            "url": CONFIG['MODULE'] + '/Single/getList', // ajax source
          },
          keys: true,
          columns: [
            {
            ...
            },
            {
              "render": function (data, type, row) {
                ...
                return '<a href="./edit/id/' + row.id + '" class="btn dark btn-sm btn-outline margin-bottom-5"> <i class="fa fa-edit"></i> 编辑 </a>'
                  ...
                  + '<a href="./execute_history/id/' + row.id + '" class="btn green-jungle btn-sm btn-outline margin-bottom-5"> <i class="fa fa-history"></i> 执行记录 </a>';
