      ...
      var initPickers = function () {
        ...
        var handleRecords = function () {
                    ...
                    "columnDefs": [
                        ...
                        },
                        {
                            "render": function (data, type, row) {
                                ...
                                return '<a target="_blank" href="/Single/execute_history_pub_show/tid/'+CONFIG.ID+'/id/' + data.id + '" class="btn green-jungle btn-sm btn-outline margin-bottom-5"> <i class="fa fa-info-circle"></i> 查看 </a>';
            ...
            $("#execute_diff").on('click', function () {
                ...
                $(this).attr('href', '/Single/execute_history_pub_diff/tid/'+CONFIG.ID+'/id/' + CONFIG['ID'] + '?history_ids=' + _ids.join(','));
            });
